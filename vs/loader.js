    ...
    var t = function() {
      ...
      , o = function() {
        ...
        t.prototype._loadAndEvalScript = function(t, r, n, o, i, s) {
            ...
            return d.runInThisContext(i).call(e.global, t.getGlobalAMDRequireFunc(), t.getGlobalAMDDefineFunc(), n, this._path.dirname(r)),
            s.record(32, r),
            d
        }
        ,
                    ...
                    if (d !== o.MODULE)
                        if (d !== o.REQUIRE) {
                            ...
                            if (a && a.isComplete())
                                ...
                                u.reverse(),
                                u.push(d.id),
                                console.warn(u.map(function(e) {
                                    return t._moduleIdProvider.getStrModuleId(e)
                                }).join(" => \n")),
                                e.unresolvedDependenciesCount--
                            } else if (this._inverseDependencies2[d.id] = this._inverseDependencies2[d.id] || [],
...
!function(e) {
    function t() {
        ...
        require = s) : (r.isElectronRenderer || (e.global.define = o),
        e.global.require = s)
    }
    ...
    ,
    e.init = t,
    "function" == typeof e.global.define && e.global.define.amd || (n = new e.ModuleManager(r,e.createScriptLoader(r),o,s,e.Utilities.getHighPerformanceTimestamp()),
